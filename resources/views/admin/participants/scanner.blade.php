<x-app-layout>
  ...
  <style>
    ...
    .result-card.success .result-name {
      color: #1A3A2A;
    }

    .result-card.error .result-name {
      color: #7A1A10;
    }

    .result-card.warning .result-name {
      color: #7A3F08;
    }
  ...
  <div class="scanner-page">
    <div class="scanner-wrap">
      ...
      <div class="scanner-box" id="scanner-box">
        ...
        <div id="reader"></div>
        <button class="camera-toggle-btn" id="camera-toggle-btn" title="Ganti kamera">
          🔄
        </button>
      </div>
...
function startScanner() {
  Html5Qrcode.getCameras().then(devices => {
    ...
    // Default: coba mulai dari kamera belakang
    ...
    // Sembunyikan tombol toggle kalau cuma ada 1 kamera
    const toggleBtn = document.getElementById('camera-toggle-btn');
    if (cameras.length < 2) {
      toggleBtn.style.display = 'none';
    }

    runCamera(cameras[currentCamIdx].id);
  });
}
...
document.getElementById('camera-toggle-btn').addEventListener('click', switchCamera);
