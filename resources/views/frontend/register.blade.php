...
.reg-header-title em { color: var(--forest-light); font-style: italic; }
.reg-header-sub {
...
.reg-section-label {
  ...
  color: var(--forest-light); margin-bottom: 4px;
}
.reg-section-title {
  font-family: 'Playfair Display', serif;
...
label .req { color: var(--forest-light); margin-left: 2px; }
label .opt {
...
.reg-summary-item-label {
  ...
  letter-spacing: 0.15em; color: var(--text-muted); font-weight: 500;
}
...
.agree-text a { color: var(--forest-light); text-decoration: underline; }
...
@media (max-width: 600px) {
  ...
  .reg-submit-wrap { padding: 20px 20px 32px; }
  .reg-header-title { font-size: 30px; }
  .reg-summary { gap: 12px; }
  .reg-summary-sep { display: none; }
}
</style>
                        ...
                        @foreach($shirtSizes as $size)
                            <div class="size-opt">
                                <input
                                    ...
                                    id="size_{{ $size->id }}"
                                    value="{{ $size->id }}"
                                    {{ old('shirt_size_id') == $size->id ? 'checked' : '' }}
                                    required
                                >
                ...
                <div style="display: flex; flex-direction: column; gap: 20px;">
                    ...
                    <div class="field">
                        ...
                        <textarea
                            id="medical_notes"
                            name="medical_notes"
                            placeholder="Mention any conditions, allergies, or limitations the medical team should know about..."
                        >{{ old('medical_notes') }}</textarea>
                        <span class="field-hint">This information will only be used by our medical team if needed.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="reg-section" style="display: flex; flex-direction: column; gap: 16px;">
                ...
                <div class="reg-summary">
                    ...
                    <div class="reg-summary-item">
                        ...
                        <span class="reg-summary-item-value" style="color: var(--forest-light); font-weight: 600;">Rp 50.000</span>
                    </div>
                </div>

                <div class="agree-row">
                    <input type="checkbox" id="agree" name="agree" required>
                    <label for="agree" class="agree-text" style="font-size: 13px; font-weight: 400; letter-spacing: 0;">
                        I have read and agree to the <a href="#">Participant Guidelines</a>. I understand that photos and videos may be taken during the event for documentation and promotional purposes.
                    </label>
                </div>
            </div>
