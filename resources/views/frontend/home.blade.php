  ...
  <style>
    ...
    *::after {
    ...
    .benefit-card:hover {
      ...
      box-shadow: 0 12px 40px rgba(26, 67, 50, 0.1);
    }
    ...
    .contact-card:hover {
      background: var(--jade-pale);
      border-color: rgba(26, 67, 50, 0.2);
    }
    ...
    .partner-box:hover {
      box-shadow: 0 4px 20px rgba(26, 67, 50, 0.08);
    }
    ...
    @media (max-width: 900px) {
      ...
      .info-cell {
        border-right: none;
        border-bottom: 1px solid rgba(26, 67, 50, 0.12);
      }
...
<body>
    ...
    <div class="hero-inner">
      <div>
        ...
        <div class="hero-collab">
          ...
          In collaboration with <strong>Embassy of India, Jakarta</strong> · <strong>JNICC Jakarta</strong> ·
          <strong>Honorary Consul of India, Surabaya</strong> &amp; <strong>International Office and
            Partnership</strong>
        </div>
      ...
      <div class="hero-poster-wrap">
        ...
        <img class="hero-poster-img" src="{{ asset('images/poster6.jpeg') }}"
    ...
    <div class="countdown-inner">
      ...
      <div class="cal-wrap">
        ...
        <div class="cal-dropdown" id="cal-dropdown">
          ...
          <a class="cal-option" id="ical-link" href="#" download="international-day-of-yoga-2026.ics"
            onclick="closeCal()">
  ...
  <section id="schedule" class="section schedule-bg">
    <div class="section-inner">
      ...
      <p class="sched-note reveal">* Schedule may be adjusted by the organizing committee. Please arrive by 05.45 WIB.
      </p>
    </div>
  </section>
      ...
      <div class="notice-cards">
        <div class="notice-card reveal">
          ...
          <div>
            ...
            <p class="notice-card-text">Kapasitas parkir terbatas untuk <strong>2.000 peserta</strong>. Sangat
              disarankan menggunakan <strong>motor, angkutan umum, atau datang bersama rombongan</strong> untuk
              menghindari kemacetan dan kesulitan parkir di area Campus 2.</p>
          </div>
        </div>
        ...
        <div class="notice-card reveal reveal-delay-2">
          ...
          <div>
            ...
            <p class="notice-card-text">Gelang peserta yang diterima saat registrasi merupakan <strong>identitas
                resmi</strong> untuk memasuki area kegiatan dan mendapatkan seluruh fasilitas dari panitia. Wajib
              dipakai sepanjang acara.</p>
          </div>
        </div>
        <div class="notice-card reveal reveal-delay-3">
          ...
          <div>
            ...
            <p class="notice-card-text">Event dilaksanakan <strong>outdoor</strong>. Siapkan <strong>sunscreen,
                topi/pelindung kepala</strong>, dan bawa <strong>payung lipat atau jas hujan ringan</strong> sebagai
              antisipasi perubahan cuaca.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="section-inner">
      ...
      <div class="benefits-grid">
        <div class="benefit-card reveal">
          ...
          <p class="benefit-text">Improve your body's flexibility and overall physical mobility through guided practice.
          </p>
        </div>
  ...
  <section id="guest" class="guest-sec">
    ...
    <div class="guest-inner">
      <div class="reveal">
        ...
        <p class="guest-desc">
          Anjasmara will personally lead the mass yoga session for all 2,000 participants. A celebrated Indonesian actor
          and dedicated yoga master, he brings decades of holistic wellness practice to inspire everyone toward a
    ...
    <div class="section-inner">
      ...
      <div class="guidelines-grid reveal">
        ...
        <div class="gl-card">
          ...
          <ul class="gl-list">
            <li><span class="gl-check">✓</span> Enter through the <strong>West Entrance</strong> of Football Field,
              Campus 2.</li>
  ...
  <div class="fab-wrap">
    <a class="fab-btn fab-ig" href="https://www.instagram.com/yoga.unwahas/" target="_blank" rel="noopener">
      <div class="fab-icon">
      ...
      <div class="fab-label">Instagram <span class="fab-sublabel"></span></div>
    </a>
    <a class="fab-btn fab-wa" href="https://chat.whatsapp.com/GQA5U5j6JYS87FVZnpGs38" target="_blank" rel="noopener">
      <div class="fab-icon">
      ...
      <div class="fab-label">Join Group <span class="fab-sublabel">WhatsApp</span></div>
    </a>
  </div>
</body>
