...
<head>
  ...
  <title>International Day of Yoga 2026 · UNWAHAS</title>
  <link
  ...
  <style>
    ...
    *::after {
    ...
    .nav-cta:hover { background: #F0A55A !important; }
    ...
    .nav-drawer .drawer-cta {
      margin-top: 12px; background: var(--saffron); color: var(--jade);
    ...
    /* ── LOGO BAR (full-width strip between nav and hero) ── */
    .logo-bar {
      position: fixed;
      top: 72px;
      left: 0; right: 0;
      ...
      border-bottom: 1px solid rgba(26,67,50,0.1);
      display: flex;
      align-items: stretch;
      box-shadow: 0 2px 12px rgba(26,67,50,0.07);
    }
    ...
    .logo-bar-item {
      ...
      justify-content: center;
      padding: 16px 12px;
      border-right: 1px solid rgba(26,67,50,0.08);
      transition: background 0.2s;
      min-height: 96px;
    }

    .logo-bar-item:last-child { border-right: none; }
    .logo-bar-item:hover { background: rgba(232,147,58,0.06); }
    ...
    .logo-bar-item:hover img { transform: scale(1.08); }
    ...
    .hero-eyebrow-line { width: 40px; height: 1px; background: var(--saffron); }
    ...
    .hero-tagline {
      ...
      color: rgba(255,255,255,0.5); margin-bottom: 36px; max-width: 400px;
    }
    ...
    /* IDY poster placeholder */
    .hero-poster-placeholder {
      width: 100%; border-radius: 16px;
      background: linear-gradient(135deg, rgba(232,147,58,0.15) 0%, rgba(82,183,136,0.1) 100%);
    ...
    .poster-idy-day {
      ...
      color: var(--saffron); font-weight: 500; margin-bottom: 8px;
    }

    .poster-idy-num {
      font-size: 96px; font-weight: 700; color: var(--white);
      line-height: 0.9; margin-bottom: 8px;
    }

    .poster-idy-month {
      font-size: 28px; font-style: italic; color: var(--saffron);
    ...
    .poster-idy-title {
      ...
      color: rgba(255,255,255,0.6); font-weight: 400; line-height: 1.4;
      text-align: center;
    }

    .poster-idy-year {
      font-size: 48px; font-weight: 700; color: rgba(255,255,255,0.1);
      position: absolute; bottom: 20px; right: 24px;
    }

    /* ── INFO STRIP ── */
    .info-strip { background: var(--saffron); position: relative; z-index: 1; }
    ...
    .info-cell {
      ...
      gap: 16px; border-right: 1px solid rgba(26,67,50,0.12);
    }
    ...
    .ic-icon {
      ...
      background: rgba(26,67,50,0.12); border-radius: 10px;
    ...
    .ic-label {
      ...
      text-transform: uppercase; color: rgba(26,67,50,0.5); margin-bottom: 3px;
    }
    ...
    /* ── COUNTDOWN ── */
    .countdown {
      background: var(--jade); padding: 72px 48px;
    ...
    .cd-num {
      font-family: 'Cormorant Garamond', serif;
      font-size: 58px; font-weight: 700; color: var(--white);
      line-height: 1; letter-spacing: -0.02em;
      transition: transform 0.25s ease, opacity 0.25s ease;
    }

    .cd-num.flip { transform: translateY(-10px); opacity: 0; }
    .cd-lbl { font-size: 10px; font-weight: 500; letter-spacing: 0.2em; text-transform: uppercase; color: rgba(255,255,255,0.3); }
    ...
    .cd-done {
      ...
      color: var(--saffron); display: none; margin-top: 16px;
    }
    ...
    .section-eyebrow-text { font-size: 11px; font-weight: 500; letter-spacing: 0.22em; text-transform: uppercase; color: var(--jade-bright); }

    .section-title {
      font-family: 'Cormorant Garamond', serif;
      font-size: 48px; font-weight: 700; line-height: 1.1;
      color: var(--jade); margin-bottom: 60px;
    }
    ...
    .sched-num {
      ...
      color: rgba(26,67,50,0.06); line-height: 1; margin-bottom: 12px;
    }

    .sched-time { font-size: 11px; font-weight: 600; color: var(--saffron); letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 10px; }
    .sched-title { font-family: 'Cormorant Garamond', serif; font-size: 18px; font-weight: 600; color: var(--jade); margin-bottom: 8px; line-height: 1.2; }
    .sched-desc { font-size: 13px; color: var(--ink-muted); line-height: 1.65; }
    .sched-note { text-align: center; margin-top: 20px; font-size: 12px; color: var(--ink-muted); font-style: italic; }
    ...
    .benefit-icon-wrap {
      width: 52px; height: 52px; background: var(--jade-pale);
      border-radius: 12px; display: flex; align-items: center;
      justify-content: center; font-size: 28px; margin-bottom: 20px;
    }

    .benefit-title { font-family: 'Cormorant Garamond', serif; font-size: 18px; font-weight: 700; color: var(--jade); margin-bottom: 10px; }
    .benefit-text { font-size: 13px; color: var(--ink-muted); line-height: 1.65; }

    /* ── FACILITIES ── */
    .facilities-bg { background: var(--white); }

    .facilities-grid { display: grid; grid-template-columns: repeat(auto-fit,minmax(200px,1fr)); gap: 14px; }

    .facility-card {
      border: 1px solid var(--line); border-radius: 12px; padding: 24px 20px;
      background: var(--ivory); display: flex; align-items: flex-start; gap: 14px;
      transition: border-color 0.2s, background 0.2s;
    }

    .facility-card:hover { border-color: rgba(232,147,58,0.3); background: var(--saffron-pale); }
    ...
    /* ── GUEST ── */
    .guest-sec { background: var(--jade); position: relative; overflow: hidden; }
    ...
    .guest-eye { display: flex; align-items: center; gap: 12px; margin-bottom: 16px; }
    .guest-eye-line { width: 32px; height: 1px; background: var(--saffron); }
    .guest-eye-text { font-size: 11px; font-weight: 500; letter-spacing: 0.22em; text-transform: uppercase; color: var(--saffron); }

    .guest-name { font-family: 'Cormorant Garamond', serif; font-size: 80px; font-weight: 700; color: var(--white); line-height: 0.95; letter-spacing: -0.02em; margin-bottom: 16px; }
    .guest-role { font-size: 15px; font-weight: 300; color: rgba(255,255,255,0.45); margin-bottom: 28px; line-height: 1.6; }
    ...
    .guest-desc { font-size: 14px; line-height: 1.8; font-weight: 300; color: rgba(255,255,255,0.5); max-width: 480px; }
    .guest-divider { width: 48px; height: 1px; background: rgba(232,147,58,0.4); margin: 28px 0; }

    .guest-photo-wrap { position: relative; }
    .guest-photo-ring1 { position: absolute; inset: -20px; border: 1px solid rgba(232,147,58,0.18); border-radius: 24px; transform: rotate(-2.5deg); }
    .guest-photo-ring2 { position: absolute; inset: -10px; border: 1px solid rgba(232,147,58,0.1); border-radius: 20px; transform: rotate(1deg); }

    .guest-photo-img { width: 100%; border-radius: 16px; display: block; position: relative; z-index: 1; object-fit: cover; object-position: top center; }
    ...
    .bring-grid { display: grid; grid-template-columns: repeat(auto-fit,minmax(220px,1fr)); gap: 14px; }

    .bring-card {
      border: 1px solid var(--line); border-radius: 12px; padding: 24px;
      background: var(--ivory); display: flex; align-items: flex-start;
      gap: 14px; transition: all 0.2s;
    }

    .bring-card:hover { background: var(--saffron-pale); border-color: rgba(232,147,58,0.3); }

    .bring-icon { font-size: 28px; flex-shrink: 0; width: 44px; height: 44px; display: flex; align-items: center; justify-content: center; }
    .bring-text { font-size: 13.5px; color: var(--ink-mid); line-height: 1.6; padding-top: 8px; }

    .bring-note { text-align: center; margin-top: 24px; font-size: 13px; color: var(--jade-mid); background: var(--jade-pale); border: 1px solid rgba(26,67,50,0.15); border-radius: 8px; padding: 14px 20px; display: inline-block; }
    .bring-note-wrap { text-align: center; }

    /* ── GUIDELINES ── */
    .guidelines-bg { background: var(--parchment); }

    .guidelines-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; }

    .gl-card { background: var(--white); border: 1px solid var(--line); border-radius: 16px; padding: 32px; }

    .gl-head { display: flex; align-items: center; gap: 12px; margin-bottom: 24px; padding-bottom: 20px; border-bottom: 1px solid var(--line); }
    ...
    .gl-title { font-family: 'Cormorant Garamond', serif; font-size: 20px; font-weight: 700; color: var(--jade); }

    .gl-list { list-style: none; }

    .gl-list li { font-size: 13px; color: var(--ink-mid); padding: 8px 0; border-bottom: 1px solid rgba(26,24,20,0.06); display: flex; align-items: flex-start; gap: 10px; line-height: 1.6; }
    ...
    .contact-card { border: 1px solid var(--line); border-radius: 12px; padding: 24px; background: var(--ivory); display: flex; align-items: center; gap: 14px; transition: all 0.2s; }
    .contact-card:hover { background: var(--jade-pale); border-color: rgba(26,67,50,0.2); }

    .contact-icon-wrap { width: 44px; height: 44px; border-radius: 10px; background: var(--jade); display: flex; align-items: center; justify-content: center; font-size: 20px; flex-shrink: 0; }
    .contact-label { font-size: 10px; color: var(--ink-muted); text-transform: uppercase; letter-spacing: 0.12em; margin-bottom: 4px; font-weight: 500; }
    ...
    .partner-box img { max-height: 54px; max-width: 130px; object-fit: contain; }

    /* ── CTA ── */
    .cta-sec { background: var(--jade); padding: 120px 48px; text-align: center; position: relative; overflow: hidden; }
    .cta-bg { position: absolute; inset: 0; background: radial-gradient(ellipse 70% 100% at 50% 50%, rgba(232,147,58,0.08) 0%, transparent 60%); pointer-events: none; }
    .cta-decor { position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%); width: 600px; height: 600px; border: 1px solid rgba(232,147,58,0.06); border-radius: 50%; pointer-events: none; }
    .cta-decor2 { position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%); width: 400px; height: 400px; border: 1px solid rgba(232,147,58,0.08); border-radius: 50%; pointer-events: none; }

    .cta-quote { font-family: 'Cormorant Garamond', serif; font-style: italic; font-size: 20px; font-weight: 300; color: rgba(255,255,255,0.3); max-width: 600px; margin: 0 auto 32px; position: relative; z-index: 1; }
    .cta-title { font-family: 'Cormorant Garamond', serif; font-size: 64px; font-weight: 700; color: var(--white); line-height: 1.05; margin-bottom: 12px; position: relative; z-index: 1; }
    .cta-title em { color: var(--saffron); font-style: italic; }
    .cta-subtitle { font-size: 14px; font-weight: 300; color: rgba(255,255,255,0.45); margin-bottom: 48px; position: relative; z-index: 1; }
    ...
    .cta-note { font-size: 12px; color: rgba(255,255,255,0.25); margin-top: 20px; position: relative; z-index: 1; }

    /* ── FOOTER ── */
    footer {
      background: #0E2B1E; padding: 40px 48px;
    ...
    .footer-link { font-size: 13px; color: rgba(255,255,255,0.35); text-decoration: none; display: flex; align-items: center; gap: 6px; transition: color 0.2s; }
    .footer-link:hover { color: rgba(232,147,58,0.8); }

    .footer-copy { font-size: 12px; color: rgba(255,255,255,0.2); }

    /* ── IMPORTANT NOTICE BANNER ── */
    .notice-banner { background: var(--saffron-pale); border-top: 3px solid var(--saffron); padding: 40px 48px; position: relative; z-index: 1; }
    .notice-banner-inner { max-width: 1200px; margin: 0 auto; }

    .notice-title { font-family: 'Cormorant Garamond', serif; font-size: 22px; font-weight: 700; color: var(--jade); margin-bottom: 20px; display: flex; align-items: center; gap: 10px; }

    .notice-cards { display: grid; grid-template-columns: repeat(auto-fit,minmax(260px,1fr)); gap: 14px; }

    .notice-card { background: var(--white); border: 1px solid rgba(232,147,58,0.25); border-left: 4px solid var(--saffron); border-radius: 0 10px 10px 0; padding: 18px 20px; display: flex; align-items: flex-start; gap: 14px; }
    .notice-icon { font-size: 28px; flex-shrink: 0; line-height: 1; margin-top: 2px; }
    .notice-card-title { font-size: 14px; font-weight: 600; color: var(--jade); margin-bottom: 5px; }
    .notice-card-text { font-size: 13px; color: var(--ink-mid); line-height: 1.6; }
    .notice-card-text strong { color: var(--saffron-deep); }

    /* ── ADD TO CALENDAR ── */
    .cal-wrap { margin-top: 28px; display: flex; justify-content: center; position: relative; }

    .cal-btn {
      background: rgba(255,255,255,0.1); border: 1px solid rgba(232,147,58,0.35);
      color: rgba(255,255,255,0.85); padding: 12px 28px; border-radius: 6px;
      font-size: 13px; font-weight: 500; cursor: pointer; letter-spacing: 0.04em;
      display: flex; align-items: center; gap: 8px; transition: all 0.2s;
      font-family: 'Outfit', sans-serif;
    }

    .cal-btn:hover { background: rgba(232,147,58,0.15); border-color: rgba(232,147,58,0.6); color: var(--white); }

    .cal-dropdown {
      position: absolute; top: calc(100% + 8px); left: 50%;
      transform: translateX(-50%);
      background: var(--white); border: 1px solid var(--line);
      border-radius: 10px; box-shadow: 0 8px 32px rgba(26,67,50,0.15);
      min-width: 220px; overflow: hidden; display: none; z-index: 10;
    }

    .cal-dropdown.open { display: block; }

    .cal-option { display: flex; align-items: center; gap: 10px; padding: 13px 18px; font-size: 13px; font-weight: 500; color: var(--ink-mid); text-decoration: none; border-bottom: 1px solid rgba(26,24,20,0.06); transition: background 0.15s; cursor: pointer; }
    ...
    @media (max-width: 900px) {
      ...
      .logo-bar { top: 72px; overflow-x: auto; flex-wrap: nowrap; }
      .logo-bar-item { min-width: 80px; flex: 0 0 auto; padding: 10px 12px; min-height: 72px; }
      .logo-bar-item img { height: 48px; max-width: 68px; }

      .hero { padding-top: calc(72px + 72px); }
...
<body>
  ...
  <!-- ── NAV ── -->
  <nav>
    <div class="nav-brand">International <span>Yoga Day</span> 2026</div>
    <div class="nav-links">
  ...
  <div class="logo-bar">
    ...
    <div class="logo-bar-item">
      <img src="{{ asset('images/HCoI.png') }}" alt="Honorary Consul of India Surabaya">
    </div>
    <div class="logo-bar-item">
    ...
    <div class="hero-inner">
      <div>
        ...
        <div class="hero-logos">
          <div class="logo-pill">
            <img src="{{ asset('images/kota-semarang.png') }}" alt="">
            Kota Semarang
          </div>
          <div class="logo-pill">
            <img src="{{ asset('images/jncc.jpeg') }}" alt="">
            JNICC Jakarta
          </div>
          <div class="logo-pill">
          ...
          <div class="logo-pill">
            <img src="{{ asset('images/hcgi.jpeg') }}" alt="">
            Hon. Consul India
          </div>
          <div class="logo-pill">
            <img src="{{ asset('images/yoga365.png') }}" alt="">
            Yoga 365
          </div>
          <div class="logo-pill">
            <img src="{{ asset('images/kemenpar.png') }}" alt="">
            Kemenpar RI
          </div>
          <div class="logo-pill">
            <img src="{{ asset('images/wonderful-indonesia.png') }}" alt="">
            Wonderful Indonesia
          </div>
          <div class="logo-pill">
            <img src="{{ asset('images/indonesia-mitra.png') }}" alt="">
            Partners Forever
          </div>
        </div>

        {{-- <div class="idy-badge">
          <div class="idy-badge-dot"></div>
        ...
        <div class="hero-collab">
          ...
          In collaboration with <strong>Embassy of India, Jakarta</strong> · <strong>JNICC Jakarta</strong> · <strong>Honorary Consul of India, Surabaya</strong> &amp; <strong>International Office and Partnership</strong>
        </div>
    ...
    <div class="countdown-inner">
      ...
      <div class="cal-wrap">
        ...
        <div class="cal-dropdown" id="cal-dropdown">
          ...
          <a class="cal-option" id="ical-link" href="#" download="international-day-of-yoga-2026.ics" onclick="closeCal()">
      ...
      <div class="facilities-grid reveal">
        <div class="facility-card">
          ...
          <div>
            ...
            <p class="fac-desc">Kaos peserta resmi International Day of Yoga 2026.</p>
          </div>
        </div>
        <div class="facility-card">
          <div class="fac-icon">🧘</div>
  ...
  {{-- <section class="section partners-bg" style="padding-top:0;">
    <div class="section-inner">
      ...
      <div class="partners-row reveal">
        ...
        <div class="partner-box">
          <img src="{{ asset('images/hcgi.jpeg') }}" alt="Honorary Consul of India Surabaya">
        </div>
        <div class="partner-box">
          <img src="{{ asset('images/yoga365.png') }}" alt="Yoga 365">
        </div> 
  ...
  <script>
    ...
    /* ── ADD TO CALENDAR ── */
    (function () {
      var title = 'International Day of Yoga 2026 — UNWAHAS';
      ...
      var gParams = new URLSearchParams({ action: 'TEMPLATE', text: title, location: loc, details: desc, dates: startUTC + '/' + endUTC });
      document.getElementById('gcal-link').href = 'https://calendar.google.com/calendar/render?' + gParams.toString();

      var oParams = new URLSearchParams({ path: '/calendar/action/compose', rru: 'addevent', subject: title, location: loc, body: desc, startdt: '2026-06-20T06:30:00', enddt: '2026-06-20T09:00:00' });
      document.getElementById('outlook-link').href = 'https://outlook.live.com/calendar/0/deeplink/compose?' + oParams.toString();

      var ics = ['BEGIN:VCALENDAR','VERSION:2.0','PRODID:-//IDY2026//EN','CALSCALE:GREGORIAN','BEGIN:VEVENT','DTSTART;TZID=Asia/Jakarta:20260620T063000','DTEND;TZID=Asia/Jakarta:20260620T090000','SUMMARY:' + title,'DESCRIPTION:' + desc,'LOCATION:' + loc,'BEGIN:VALARM','TRIGGER:-PT60M','ACTION:DISPLAY','DESCRIPTION:Reminder','END:VALARM','END:VEVENT','END:VCALENDAR'].join('\r\n');
      var blob = new Blob([ics], { type: 'text/calendar;charset=utf-8' });
      document.getElementById('ical-link').href = URL.createObjectURL(blob);
    })();

    function toggleCal() { document.getElementById('cal-dropdown').classList.toggle('open'); }
    function closeCal() { setTimeout(function () { document.getElementById('cal-dropdown').classList.remove('open'); }, 150); }
